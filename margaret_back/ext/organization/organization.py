...
def remove_org():
    data = request.get_json()
    return organization_controller.remove_organization(data['org_Id'])\
        .to_json()
...
def update_org(org_id):
    ...
    return organization_controller.modify_organization_by_atribute(org_id,
                                                                   args[0][0],
                                                                   args[0][1])\
        .to_json()
...
def search_org():
    ...
    search_result = organization_controller.find_organization_by_atribute(
        args[0][0], args[0][1])
