...
def test_user_nome():
    ...
    user = User("Vladimir Lenin",
                "lenin.vladimir@ccc.ufcg.edu.br", "lenin#0803")
...
def test_user_discord_wrong_format():
    ...
    try:
        user = User("Vladimir Lenin",
                    "lenin.vladimir@ccc.ufcg.edu.br", "lenin#803")
        fail()
    except AttributeError:
        pass
    ...
    try:
        user = User("Vladimir Lenin",
                    "lenin.vladimir@ccc.ufcg.edu.br", "lenin0803")
        fail()
    except AttributeError:
        pass
    ...
    try:
        user = User("Vladimir Lenin",
                    "lenin.vladimir@ccc.ufcg.edu.br", "lenin#lenin")
        fail()
    except AttributeError:
        pass
...
def test_user_email_wrong_format():
    ...
    try:
        user = User("Vladimir Lenin",
                    "lenin.vladimirccc.ufcg.edu.br", "lenin#0803")
        fail()
    except AttributeError:
        pass
    ...
    try:
        user = User("Vladimir Lenin",
                    "lenin.vladimir@ufcg.edu.br", "lenin#0803")
        fail()
    except AttributeError:
        pass
